...
<script type="text/javascript">
    ...
    var tasksListAjaxUrl = "/local/components/bitrix/tasks.list/ajax.php?SITE_ID=<?php echo SITE_ID?><?=$arParams['GROUP_ID'] ? "&GROUP_ID=" . $arParams["GROUP_ID"] : ""?>";
...
$APPLICATION->includeComponent("bitrix:spotlight", "", array(
	"ID" => "tasks-print-feature",
	"JS_OPTIONS" => array(
		"targetElement" => ".task-gantt-print",
		"content" => Loc::getMessage("TASKS_GANTT_PRINT_SPOTLIGHT_TEXT"),
		"targetVertex" => "middle-center",
		"left" => 10,
		"END_DATE" => gmmktime(8, 30, 0, 5, 10, 2018),
	)
));
