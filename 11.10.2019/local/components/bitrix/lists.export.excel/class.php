...
class ListExportExcelComponent extends CBitrixComponent
{
	...
	protected function createDataExcel()
	{
		...
		if (!count($gridColumns) || in_array("IBLOCK_SECTION_ID", $gridColumns))
		{
			...
			//Отключил функцил
//            $this->arResult["ELEMENTS_HEADERS"]["PROPERTY_100"] = 'Двигатель';
//            $this->arResult["ELEMENTS_HEADERS"]["PROPERTY_101"] = 'Тип кузова';
//            $this->arResult["ELEMENTS_HEADERS"]["PROPERTY_102"] = 'Система охлаждения';
//            $this->arResult["ELEMENTS_HEADERS"]["PROPERTY_103"] = 'Доп оборудование';
//            $this->arResult["ELEMENTS_HEADERS"]["PROPERTY_104"] = '№ машины';
//            $this->arResult["ELEMENTS_HEADERS"]["PROPERTY_105"] = 'VIN code';
//            $this->arResult["ELEMENTS_HEADERS"]["PROPERTY_106"] = 'Дата изготовления';
//            $this->arResult["ELEMENTS_HEADERS"]["PROPERTY_107"] = 'ROPS';
//            $this->arResult["ELEMENTS_HEADERS"]["PROPERTY_108"] = 'Vebasto';
//            $this->arResult["ELEMENTS_HEADERS"]["PROPERTY_109"] = 'Комментарий';
...
//Отключил функционал доп полей
        /*$gridColumns[] = "PROPERTY_100";
        $gridColumns[] = "PROPERTY_101";
        $gridColumns[] = "PROPERTY_102";
        $gridColumns[] = "PROPERTY_103";
        $gridColumns[] = "PROPERTY_104";
        $gridColumns[] = "PROPERTY_105";
        $gridColumns[] = "PROPERTY_106";
        $gridColumns[] = "PROPERTY_107";
        $gridColumns[] = "PROPERTY_108";
        $gridColumns[] = "PROPERTY_109";*/
		...
		while($obElement = $rsElements->GetNextElement())
		{
            ...
            //Отключил функционал доп полей
            /*if($data['IBLOCK_ID'] == 31) {
			    $data_prop = $this->getStoreList($data['ID']);
                $data['PROPERTY_100'] = $data_prop['PROPERTY_100_VALUE'];
                $data['PROPERTY_101'] = $data_prop['PROPERTY_101_VALUE'];
                $data['PROPERTY_102'] = $data_prop['PROPERTY_102_VALUE'];
                $data['PROPERTY_103'] = $data_prop['PROPERTY_103_VALUE'];
                $data['PROPERTY_104'] = $data_prop['PROPERTY_104_VALUE'];
                $data['PROPERTY_105'] = $data_prop['PROPERTY_105_VALUE'];
                $data['PROPERTY_106'] = $data_prop['PROPERTY_106_VALUE'];
                $data['PROPERTY_107'] = $data_prop['PROPERTY_107_VALUE'];
                $data['PROPERTY_108'] = $data_prop['PROPERTY_108_VALUE'];
                $data['PROPERTY_109'] = $data_prop['PROPERTY_109_VALUE'];
            }*/
			...
			foreach ($gridColumns as $position => $id)
			{
				...
				$this->arResult["EXCEL_CELL_VALUE"][$count_s][$position] = is_array($data[$id]) ?
    ...
    private function getStoreList($id)
    {
        $arSelect = Array("ID", "PROPERTY_98");
        $arFilter = Array("IBLOCK_ID"=> 31, 'ID'=> $id);
        $res = CIBlockElement::GetList(Array(), $arFilter, false, false, $arSelect);
        if ($ob = $res->GetNextElement())
            $arFields = $ob->GetFields();
        if($arFields['PROPERTY_98_VALUE'] > 0) {
            return $this->getPropertyProduct($arFields['PROPERTY_98_VALUE']);
        }
    }

    private function getPropertyProduct($id)
    {
