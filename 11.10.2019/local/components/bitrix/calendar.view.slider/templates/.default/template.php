			...
			<div class="calendar-slider-detail calendar-slider-detail-panel">
				<div class="calendar-slider-detail-info">
					...
					<div class="calendar-slider-detail-content">
                        ...
                        <?if($arParams['event']['ID'] > 0):
                            $id_meet = getMeetingId($arParams['event']['ID']);
                            if($id_meet > 0):?>
                                <div class="calendar-slider-detail-place">
                                    <div class="calendar-slider-detail-place-title">Повестка дня</div>
                                    <div class="calendar-slider-detail-place-name"><a href="/timeman/meeting/meeting/<?echo $id_meet;?>/#agenda_block" target="_blank">Смотреть</a></div>
                                </div>
                            <?endif;?>
                        <?endif;?>
